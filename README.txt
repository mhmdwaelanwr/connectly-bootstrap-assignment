...
- css/page.css: simple custom style
- js/login-check.js: login validation
- js/register-check.js: sign up validation

How to run:
Open index.html in a browser.
Internet connection is needed because Bootstrap is loaded from CDN.
